...
exports.MamDetails = {
    string_to_ctrits_trits: string_to_ctrits_trits,
    iota_merkle_create: iota_merkle_create,
    iota_merkle_branch: iota_merkle_branch,
    iota_merkle_siblings: iota_merkle_siblings,
    iota_merkle_slice: iota_merkle_slice,
    ctrits_trits_to_string: ctrits_trits_to_string
};
